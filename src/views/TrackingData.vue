...
import nowcastingCards from "../static/tracking_data/nowcastingCards.json";
...
<template>
  <div class="main-view">
    ...
    <section>
      <Subtitle>Nowcasting</Subtitle>
      <CardList :cards="nowcastingCards" />
    </section>
    <section>
      <CardList :cards="otherDataCards" />
    </section>
    <section>
      <Subtitle>Compendio de Estaciones</Subtitle>
      <ButtonList :buttons="compendiumButtons" />
    </section>
    <section>
      <Subtitle>Hidroestimadores</Subtitle>
      <ButtonList :buttons="hidroButtons" />
    </section>
  </div>
</template>
